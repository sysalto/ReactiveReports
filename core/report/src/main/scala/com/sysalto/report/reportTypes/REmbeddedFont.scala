...
/**
	...
	*/
case class REmbeddedFont(fontFullPath: String, override var size: Int, override var fontName: String,
                         override var attribute: RFontAttribute.Value = RFontAttribute.NORMAL,
                         override var color: RColor = RColor(0, 0, 0))
	extends RFont(size, fontName, attribute, color) {
	override def fontKeyName: String = fontName +
		(attribute match {
