...
public class MutualFundsNoAkkaJavaReport {
    ...
    private void reportHeader(Report report) throws Exception {
        ...
        URL resource = this.getClass().getResource("/images/bank_banner.jpg");
    ...
    private void changeAccount(Report report) throws Exception {
        ...
        ResultSetGroup rsGroup = ResultSetUtil.toGroup(rs);
        rsGroup.foreach(rec -> {
            Map<String, Object> crtRec = GroupUtil.<scala.collection.immutable.Map<String, Object>>getRec(rec);
